...
include './view/header.php'; ?>
    <div class="w-[30%] mx-auto">
        ...
        <p class="mt-5 text-gray-600">Login if you are a returning customer</p>
        <form action="index.php?login" method ="POST" enctype="multipart/form-data">
            <div class="">
                <div class="">
                    ...
                    <input class="outline-none pl-[2%] w-full h-11 border rounded-[8px]" type="text" name="email" placeholder="example@gmail.com">
                </div>
                <div>
                    <div class="flex items-center mt-5 mb-3">
            ...
            <div class="flex justify-between items-center mt-5">
                ...
                <div>
                    <a href="#"><p class="text-[#ef222d] hover:underline">Forgot Password</p></a>
                </div>
            </div>
            ...
            <div class="flex justify-center items-center mt-3">
                <p>Don't have an accout?</p><a class="ml-2 hover:text-[#EA2F38]" href="index.php?opt=signup"><u>Register Now</u></a>
            </div>
        </form>
    </div>
