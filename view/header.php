    ...
    <header class="">
        <section class="flex items-center justify-between w-[75%] mx-auto py-5">
            ...
            <section class="flex items-center gap-x-5">
                ...
                <section class="">
                    <button
                        class="border border-gray-500 flex items-center justify-between rounded-[19px]">
                        <input
                            class="placeholder:text-gray-500 placeholder:text-[font-sans] ml-3 w-52 h-10 outline-none"
                            type="text" placeholder="Searching here...">
                        <svg id="search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            class="icon line w-16" width="20" height="20">
                            <path id="primary" d="M17,10a7,7,0,1,1-7-7A7,7,0,0,1,17,10Zm4,11-6-6"
                                style="fill: none; stroke: rgb(234, 47, 56); stroke-linecap: round; stroke-linejoin: round; stroke-width: 3;">
                            </path>
                        </svg>
                    </button>
                </section>
                ...
                <a href="#">
                    <section
                        class="border border-[#EA2F38] flex items-center h-10 rounded-full hover:bg-gray-100">
                        <p class="text-[#EA2F38] font-sans font-[500] mx-3 ">LIÊN HỆ 
                        <p>
                            <svg id="phone" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                class="mr-[-1px] ml-[-1px] icon line border border-[#EA2F38] h-10 w-10 p-1 rounded-full bg-[#EA2F38]"
                                width="48" height="48">
                                <path id="primary"
...
?>">
                                <section
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="h-8 w-8  text-white" fill="none" viewBox="0 0 24 24"
