<?php include './view/header.php' ?>
    <div class="w-[80%] mx-auto flex flex-row gap-x-5">
        ...
        <div class="basis-3/4 mt-10">
            <h1 class="text-center font-[500] text-[24px]">Account Information</h1>
            <div class="w-[70%] mr-auto pl-5">
                ...
                <div>
                    ...
                    <input class="outline-none pl-[2%] w-full h-11 border rounded-[8px]" type="email" name="" placeholder="Enter your password">
                </div>
                <div>
                    <div class="flex items-center mt-5 mb-3">
                ...
                <div>
                    <button type="submit" name="btn_input" class="border border-[#EA2F38] bg-[#EA2F38] text-white hover:bg-white hover:text-[#EA2F38] w-full h-10 text-[18px] rounded-[10px] mt-5">Up date</button>
                </div>
            </div>
        </div>
    </div>
